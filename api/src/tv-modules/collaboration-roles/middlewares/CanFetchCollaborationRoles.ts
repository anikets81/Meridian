...
export const CanFetchCollaborationRoles = async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (!permissions) {
        $logger.error('Can not get permissions for CanFetchCollaborationRoles middleware');
