...
TaskView is source-available software. Before using it, please review the [license](https://github.com/anikets81/Meridian/blob/main/LICENSE.md) to make sure your use case is covered. Freelancers may use TaskView for their own task management (Internal Use), but providing access to clients or third parties is not permitted under the community license.
::
